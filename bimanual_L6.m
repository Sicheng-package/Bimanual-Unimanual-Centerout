...
%tcplink
    function tcpObj = initNetwork(serverFlag)
        if serverFlag
            ...
            serverPort = 30000;
            tcpObj = tcpclient(serverIP, serverPort, "Timeout", 20);
        end
    end
    ...
    function checkRemoteSignal()
        ...
        while true
            ...
            switch op
                ...
                case 4
                    rTrial = double(payload(1));
                    write(tcpObj, uint8([5, rTrial]), 'uint8');
...
%outputs
    function recordData = saveMousePathAndTrueCoordinates(pathData, cyclesCompleted, totalTime, status)
        ...
        summaryFile = fullfile(folderName,'Summary_Data_L3.xlsx');
